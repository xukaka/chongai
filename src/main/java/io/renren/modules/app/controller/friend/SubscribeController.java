...
public class SubscribeController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("app:subscribe:list")
    ...
    @RequiresPermissions("app:subscribe:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("app:subscribe:save")
    ...
    @RequiresPermissions("app:subscribe:update")
    ...
    @RequiresPermissions("app:subscribe:delete")
